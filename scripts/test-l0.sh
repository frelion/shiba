...
scripts = [
    ...
    for name in (
        ...
        "m7-concurrent-ddl", "m8-multi-source",
    )
]
for path in scripts:
    text = path.read_text()
...
for required in ("Protocol JSON/schema", "canonical digest", "PG17/18", "Phase 1", "M3.1", "M3.2", "M4.1", "M4.2", "M4.3", "M4.4", "M4.5", "M4.6", "M5.1", "M5.2", "M5.3", "M5.4", "M5.5", "M6.1", "M6.2", "M7.1", "M7.2", "M7.3", "M7.4", "M7.5", "M8.1"):
